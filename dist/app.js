(function () {
  ...
  const MESSAGES = {
    "pt-BR": {
      ...
      footerNoteFallback: "Agradecemos pela preferência.",
      ...
      searchPlaceholder: "Busque por nome, sabor ou categoria",
      ...
      serviceHelp: "Escolha se vai receber em casa, retirar no balcão ou consumir na mesa.",
      ...
      deliveryTypeHelp: "Na entrega, informe onde receber. Na retirada, busque no endereço do Tobia's.",
      ...
      addressHelp: "Informe rua, número e complemento para o entregador encontrar você.",
      ...
      nameHelp: "Informe o nome de quem vai receber ou retirar o pedido.",
      ...
      notesHelp: "Avise aqui se quer remover ingrediente, separar embalagem ou pedir algum cuidado.",
    ...
    "en-US": {
      ...
      footerNoteFallback: "Thank you for choosing us.",
      ...
      searchPlaceholder: "Search by name, flavor, or category",
      ...
      serviceHelp: "Choose whether to receive it at home, pick it up, or eat at the table.",
      ...
      pickupOption: "Pickup",
      deliveryTypeHelp: "For delivery, tell us where to bring it. For pickup, come to Tobias.",
      ...
      addressHelp: "Enter street, number, and details so the driver can find you.",
      ...
      nameHelp: "Enter the name of the person receiving or picking up the order.",
      ...
      notesHelp: "Tell us here if you want to remove an ingredient, separate packaging, or request special care.",
  ...
  Object.assign(MESSAGES["pt-BR"], {
    ...
    searchPlaceholder: "Digite nome, sabor ou categoria",
  ...
  Object.assign(MESSAGES["en-US"], {
    ...
    searchPlaceholder: "Type name, flavor, or category",
    statusFilter: "Show",
    statusActive: "Available",
    statusInactive: "Unavailable",
    visualExpanded: "Larger cards",
