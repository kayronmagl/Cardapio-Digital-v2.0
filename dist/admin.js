(function () {
  ...
  const THEME_PRESET_LABEL_KEYS = {
    ...
    carnaval: "themePresetCarnaval",
    "sao-joao-nordeste": "themePresetSaoJoaoNordeste",
    "dia-das-maes": "themePresetDiaDasMaes",
    "dia-dos-pais": "themePresetDiaDosPais",
    "dia-dos-namorados": "themePresetDiaDosNamorados",
    "dia-das-criancas": "themePresetDiaDasCriancas",
    "natal-fim-de-ano": "themePresetNatalFimDeAno",
  };
  ...
  const MESSAGES = {
    "pt-BR": {
      ...
      panelSubtitle: "Edite com calma. Ao salvar, o painel publica o cardápio se a conexão online estiver ativa.",
      ...
      authOnlineDescription: "Use o e-mail e a senha cadastrados para abrir o Admin online.",
      ...
      productsSubtitle: "Cuide do que o cliente vê: nome, preço, foto, disponibilidade e adicionais.",
      ...
      productImagesHelp: "Use uma foto que ajude o cliente a reconhecer o produto no cardápio.",
      ...
      imageUploadPublishError: "A foto não foi enviada. O produto ainda pode aparecer sem foto; confira a pasta de imagens no Supabase.",
      noImageSelected: "Nenhuma imagem escolhida.",
      productImagePublishHelp: "Ao publicar, a foto acompanha o produto no cardápio online.",
      ...
      categoriesSubtitle: "Crie os grupos que aparecem no cardápio, como pastéis, bebidas e combos.",
      categoryFormTitle: "Formulário da categoria",
      categorySlug: "Apelido para organização da categoria (opcional)",
      ...
      addOnsSubtitle: "Monte extras que o cliente pode escolher junto do produto, como queijo, molho ou borda.",
      addOnFormTitle: "Formulário do adicional",
      addOnId: "Apelido para organização do adicional (opcional)",
      ...
      offersTitle: "Combos",
      offersSubtitle: "Monte combos com produtos do cardápio para vender tudo junto por um preço fechado.",
      ...
      offerCode: "Apelido para organização do combo (opcional)",
      offerDescriptionPt: "Descrição em português",
      offerDescriptionEn: "Descrição em inglês (opcional)",
      offerImageUrl: "Imagem opcional",
      offerImageHelp: "O combo também pode aparecer sem foto; use imagem só quando ela ajudar o cliente a reconhecer a oferta.",
      ...
      comboFormHelp: "Escolha os produtos do combo, defina o preço final e deixe claro o que vem junto.",
      advancedOfferSettings: "Avançado",
      advancedOfferSettingsHelp: "Use apenas quando estiver ajustando um combo antigo e quiser manter o mesmo histórico.",
      ...
      settingsSubtitle: "Ajuste o que aparece para o cliente: loja, pedido, entrega, Pix, tema, políticas e horários.",
      ...
      settingsLocationAdvancedHelp: "Adicione o link da rota se quiser mostrar o botão do Google Maps no cardápio.",
      ...
      footerNotePtPlaceholder: "Agradecemos pela preferência.",
      footerNoteEnPlaceholder: "Thank you for choosing us.",
      brandImage: "Imagem da marca",
      brandImageHelp: "Use a logo que o cliente reconhece no topo do cardápio e no painel.",
      ...
      destaqueSubtituloPtPlaceholder: "Conte em uma frase como o cliente escolhe, revisa e envia o pedido",
      ...
      destaqueSelosHelp: "Escreva um destaque por linha, como Delivery, Retirada ou No local.",
      ...
      sectionBrandHelp: "Defina como o Tobia's aparece no topo e no rodapé do cardápio.",
      sectionDestaqueInicial: "Destaque inicial",
      sectionDestaqueInicialHelp: "Escreva a chamada principal que o cliente lê antes de escolher os produtos.",
      sectionOperation: "Operação",
      sectionOperationHelp: "Configure para onde o pedido vai, como a entrega funciona e quais formas de pagamento aparecem.",
      sectionLocation: "Localização",
      sectionLocationHelp: "Informe onde retirar pedidos e, se quiser, adicione o botão de rota para o cliente chegar melhor.",
      sectionAppearance: "Aparência",
      sectionAppearanceHelp: "Teste o visual no painel e salve quando quiser publicar a mudança para o cliente.",
      ...
      locationMapsHelp: "Cole o link da loja no Google Maps para o cliente abrir a rota com um toque.",
      ...
      deliveryLocationsHelp: "Liste os bairros ou regiões atendidas e defina se a entrega tem valor fixo ou combinado pelo WhatsApp.",
      ...
      deliveryLocationId: "Apelido para organização da localidade (opcional)",
      ...
      themePresetHelp: "Escolha um visual, veja a prévia no painel e salve para mostrar no cardápio público.",
      themePresetTechnical: "A escolha muda só o visual. Produtos, carrinho, Pix e WhatsApp continuam como estão.",
      themePresetTobiasLanches: "Tobia's Lanches",
      themePresetDarkPremium: "Tobia's Premium",
      themePresetCarnaval: "Carnaval",
      themePresetSaoJoaoNordeste: "São João do Nordeste",
      themePresetDiaDasMaes: "Dia das Mães",
      themePresetDiaDosPais: "Dia dos Pais",
      themePresetDiaDosNamorados: "Dia dos Namorados",
      themePresetDiaDasCriancas: "Dia das Crianças",
      themePresetNatalFimDeAno: "Natal e Fim de Ano",
      ...
      scheduleHelp: "Marque os dias em que o Tobia's atende e informe o horário de abertura e fechamento.",
      saveSettings: "Salvar configurações",
      backToSettingsTop: "Voltar ao topo",
      cloudTitle: "Publicação online (Supabase)",
      cloudSubtitle: "Publique o cardápio para todos, carregue o que já está online e confira se a conexão está pronta.",
      cloudUrl: "Endereço do projeto",
      cloudAnonKey: "Chave pública de acesso",
      cloudSchema: "Área dos dados",
      cloudCategories: "Lista online de categorias",
      cloudAddOns: "Lista online de adicionais",
      cloudProducts: "Lista online de produtos",
      cloudProductAddOns: "Relação online entre produtos e adicionais",
      cloudEnabled: "Modo online ativo",
      cloudRealtime: "Atualização automática (Realtime)",
      autoReconnect: "Checagem periódica opcional",
      reconnectInterval: "Tempo entre checagens",
      ...
      cloudPublishHelp: "Envia para o cardápio online tudo que está salvo neste painel.",
      cloudLoadHelp: "Traz para este painel o cardápio que já está publicado online.",
      cloudCheckHelp: "Confere se o painel consegue falar com o cardápio online.",
      cloudAdvancedTitle: "Opções avançadas",
      cloudAdvancedHelp: "Use esta parte somente quando estiver preparando ou revisando a publicação online.",
      ...
      reportsSubtitle: "Veja o que os clientes fizeram no cardápio: produtos vistos, itens adicionados, carrinhos abertos e pedidos preparados.",
      ...
      productsSeenHelp: "vezes que algum produto apareceu para o cliente",
      productsAdded: "Adicionados ao carrinho",
      productsAddedHelp: "vezes que alguém colocou item no carrinho",
      checkoutOpened: "Checkouts abertos",
      checkoutOpenedHelp: "carrinhos com item que chegaram à finalização",
      ordersPrepared: "Pedidos preparados",
      ordersPreparedHelp: "pedidos conferidos antes de abrir o WhatsApp",
      ...
      systemSubtitle: "Guarde uma cópia do cardápio, restaure uma versão anterior ou organize os dados deste aparelho.",
      ...
      backupSystemHelp: "Baixe uma cópia antes de mudanças grandes no cardápio.",
      restoreBackupHelp: "Use uma cópia salva para voltar o cardápio a um estado anterior.",
      resetSystemHelp: "Baixa uma cópia e depois deixa este aparelho com a base limpa.",
      sanitizeSystemHelp: "Organiza dados repetidos ou inconsistentes deste aparelho sem apagar o cardápio.",
      ...
      onlineConnectionFriendly: "Não foi possível conectar ao modo online. Confira os dados do Supabase.",
    ...
    "en-US": {
      ...
      panelSubtitle: "Edit calmly. When you save, the panel publishes the menu if the online connection is active.",
      ...
      authOnlineDescription: "Use the registered email and password to open the online Admin.",
      ...
      productsSubtitle: "Manage what customers see: name, price, photo, availability, and add-ons.",
      ...
      productImagesHelp: "Use a photo that helps customers recognize the product in the menu.",
      ...
      imageUploadPublishError: "The photo was not uploaded. The product can still appear without a photo; check the Supabase image folder.",
      noImageSelected: "No image selected yet.",
      productImagePublishHelp: "When publishing, the photo goes with the product to the online menu.",
      addOnsTitle: "Add-ons",
      ...
      categoriesSubtitle: "Create the groups customers see in the menu, such as snacks, drinks, and combos.",
      categoryFormTitle: "Category form",
      categorySlug: "Category organization nickname (optional)",
      ...
      addOnsSubtitle: "Create extras customers can choose with a product, such as cheese, sauce, or crust.",
      addOnFormTitle: "Add-on form",
      addOnId: "Add-on organization nickname (optional)",
      ...
      offersTitle: "Combos",
      offersSubtitle: "Build combos with menu products and sell them together for one final price.",
      comboFormTitle: "Create or edit combo",
      comboListTitle: "Combos",
      offerNamePt: "Name in Portuguese",
      offerNameEn: "Name in English (optional)",
      offerCode: "Combo organization nickname (optional)",
      ...
      offerImageHelp: "The combo can appear without a photo; use one only when it helps customers recognize the offer.",
      ...
      comboFormHelp: "Choose the combo products, set the final price, and make clear what is included.",
      advancedOfferSettings: "Advanced",
      advancedOfferSettingsHelp: "Use only when editing an older combo and keeping its history matters.",
      ...
      settingsSubtitle: "Adjust what customers see: store details, ordering, delivery, Pix, theme, policies, and hours.",
      ...
      settingsLocationAdvancedHelp: "Add the route link if you want to show the Google Maps button in the menu.",
      ...
      brandImageHelp: "Use the logo customers recognize at the top of the menu and in the panel.",
      ...
      destaqueSubtituloPtPlaceholder: "Conte em uma frase como o cliente escolhe, revisa e envia o pedido",
      destaqueSubtituloEnPlaceholder: "Choose your items, review the cart, and send the message to the business",
      destaqueSelosPt: "Top labels",
      destaqueSelosEn: "Top labels in English",
      destaqueSelosHelp: "Write one highlight per line, such as Delivery, Pickup, or Dine in.",
      ...
      sectionBrandHelp: "Define how Tobias appears at the top and footer of the menu.",
      sectionDestaqueInicial: "Top highlight",
      sectionDestaqueInicialHelp: "Write the main call customers read before choosing products.",
      sectionOperation: "Operations",
      sectionOperationHelp: "Set where orders go, how delivery works, and which payment options appear.",
      sectionLocation: "Location",
      sectionLocationHelp: "Show where customers pick up orders and add directions if useful.",
      sectionAppearance: "Appearance",
      sectionAppearanceHelp: "Preview the look in the panel and save when you want customers to see the change.",
      ...
      locationMapsUrlPlaceholder: "https://maps.app.goo.gl/...",
      locationMapsHelp: "Paste the store Google Maps link so customers can open the route with one tap.",
      ...
      deliveryLocationsHelp: "List the districts or areas served and define whether delivery has a fixed fee or is confirmed on WhatsApp.",
      ...
      deliveryLocationId: "Area organization nickname (optional)",
      ...
      themePresetHelp: "Choose a look, preview it in the panel, and save to show it in the public menu.",
      themePresetTechnical: "The choice changes only the look. Products, cart, Pix, and WhatsApp stay as they are.",
      themePresetTobiasLanches: "Tobia's Lanches",
      themePresetDarkPremium: "Tobia's Premium",
      themePresetCarnaval: "Carnival",
      themePresetSaoJoaoNordeste: "Northeast Sao Joao",
      themePresetDiaDasMaes: "Mother's Day",
      themePresetDiaDosPais: "Father's Day",
      themePresetDiaDosNamorados: "Valentine's Day",
      themePresetDiaDasCriancas: "Children's Day",
      themePresetNatalFimDeAno: "Christmas and New Year",
      ...
      scheduleHelp: "Mark the days Tobias serves customers and enter opening and closing times.",
      saveSettings: "Save settings",
      backToSettingsTop: "Back to top",
      cloudTitle: "Online publishing (Supabase)",
      cloudSubtitle: "Publish the menu for everyone, load what is already online, and check whether the connection is ready.",
      cloudOperationalHelp: "Keep automatic updates on when you want the panel to follow online changes without reloading.",
      cloudCheckAuth: "Validate online Admin login",
      cloudCheckStorage: "Check image upload",
      cloudSettingsTable: "Online settings list",
      cloudStorageBucket: "Online image folder",
      cloudTechnicalTitle: "Publishing details",
      cloudTechnicalHelp: "Check here the references used to publish. Change them only when you know what needs adjusting.",
      cloudTechnicalManaged: "References used by the panel",
      ...
      cloudLocalOnly: "Local mode active. Changes stay in this browser until online publishing is available.",
      cloudUrl: "Project address",
      cloudAnonKey: "Public access key",
      cloudSchema: "Data area",
      cloudCategories: "Online category list",
      cloudAddOns: "Online add-on list",
      cloudProducts: "Online product list",
      cloudProductAddOns: "Online relation between products and add-ons",
      cloudEnabled: "Online mode active",
      cloudRealtime: "Automatic updates (Realtime)",
      autoReconnect: "Optional periodic check",
      reconnectInterval: "Time between checks",
      saveCloud: "Save settings",
      checkConnection: "Check connection",
      migrateToCloud: "Publish changes online",
      syncToLocal: "Load online data",
      cloudPublishHelp: "Sends everything saved in this panel to the online menu.",
      cloudLoadHelp: "Brings the already published online menu into this panel.",
      cloudCheckHelp: "Checks whether the panel can reach the online menu.",
      cloudAdvancedTitle: "Advanced options",
      cloudAdvancedHelp: "Use this part only when preparing or reviewing online publishing.",
      ...
      reportsSubtitle: "See what customers did in the menu: viewed products, added items, opened carts, and prepared orders.",
      ...
      productsSeenHelp: "times a product appeared to a customer",
      productsAdded: "Added to cart",
      productsAddedHelp: "times someone added an item to the cart",
      checkoutOpened: "Checkouts opened",
      checkoutOpenedHelp: "carts with items that reached checkout",
      ordersPrepared: "Orders prepared",
      ordersPreparedHelp: "orders checked before opening WhatsApp",
      ...
      onlineConnectionFriendly: "Could not connect to online mode. Check the Supabase details.",
  ...
  Object.assign(MESSAGES["pt-BR"], {
    ...
    onlineRequired: "Entre com o e-mail e a senha do Admin online para continuar.",
    cloudSubtitle: "Publique o cardápio para todos, carregue o que já está online e confira se a conexão está pronta.",
    cloudOperationalHelp: "Deixe a atualização automática ligada quando quiser que o painel acompanhe mudanças online sem recarregar.",
      cloudCheckAuth: "Validar login do Admin online",
      cloudCheckStorage: "Verificar envio de imagens",
      cloudSettingsTable: "Lista online de configurações",
      cloudMetricEventsTable: "Lista online de métricas",
      cloudStorageBucket: "Pasta online das imagens",
    cloudTechnicalTitle: "Detalhes da publicação",
    cloudTechnicalHelp: "Confira aqui as referências usadas para publicar. Altere apenas se souber o que precisa ajustar.",
    cloudTechnicalManaged: "Referências usadas pelo painel",
    ...
    cloudLocalOnly: "Modo local ativo. As alterações ficam neste navegador até a publicação online estar disponível.",
    saveCloud: "Salvar ajustes online",
    cloudAdvancedTitle: "Preparar publicação",
    cloudAdvancedHelp: "Use esta parte somente quando estiver preparando ou revisando a publicação online.",
  ...
  Object.assign(MESSAGES["en-US"], {
    ...
    cloudOperationalHelp: "Keep automatic updates on when you want the panel to follow online changes without reloading.",
      ...
      cloudCheckStorage: "Check image upload",
      cloudSettingsTable: "Online settings list",
      cloudMetricEventsTable: "Online metrics list",
      cloudStorageBucket: "Online image folder",
    cloudTechnicalHelp: "Check here the references used to publish. Change them only when you know what needs adjusting.",
  ...
  Object.assign(MESSAGES["pt-BR"], {
    ...
    authOnlineDescription: "Use o e-mail e a senha cadastrados.",
    ...
    settingsTitle: "Configurações do cardápio",
      ...
      sectionPoliciesHelp: "Defina quais links legais aparecem no rodapé e para onde o cliente será levado ao tocar neles.",
      ...
      legalExternalUrlHelp: "Cole o link pronto da política ou dos termos. Se ficar vazio, o cardápio mostra a página interna.",
    ...
    cloudSubtitle: "Publique o cardápio para todos, carregue o que já está online e confira se a conexão está pronta.",
    cloudOperationalHelp: "Deixe a atualização automática ligada quando quiser que o painel acompanhe mudanças online sem recarregar.",
    cloudUrl: "Endereço do projeto Supabase",
  ...
  Object.assign(MESSAGES["en-US"], {
    ...
    authOnlineDescription: "Use the email and password registered.",
    ...
    settingsTitle: "Menu settings",
      ...
      sectionPoliciesHelp: "Define which legal links appear in the footer and where customers go when they tap them.",
      ...
      legalExternalUrlHelp: "Paste the ready privacy or terms link. If it stays empty, the menu shows the internal page.",
    ...
    systemSubtitle: "Keep a copy of the menu, restore an older version, or organize this device data.",
    resetSystem: "Clear this device data",
    sanitizeSystem: "Fix local data",
    resetSystemHelp: "Downloads a copy and then leaves this device with a clean base.",
    sanitizeSystemHelp: "Organizes repeated or inconsistent data on this device without deleting the menu.",
    systemSanitized: "Local data checked and fixed.",
    systemResetDone: "Menu restored to the clean base.",
    resetWarning: "Clear the menu data on this device? A safety backup will be downloaded first.",
    productSaved: "Product saved in the panel.",
  ...
  function getThemePreviewTokens(preset) {
    ...
    return {
      ...
      accentText: preset?.preview?.accentText || (darkTheme ? "#111827" : "#ffffff"),
      border: darkTheme ? "rgba(248,250,252,0.08)" : "rgba(15,23,42,0.08)",
    };
  }
  function themePreviewText(preset, field, fallbackKey) {
    return textValue(preset?.preview?.[field], currentLocale()) || t(fallbackKey);
  }
  function renderThemePreviewCard(preset) {
    const preview = getThemePreviewTokens(preset);
    const previewBadge = themePreviewText(preset, "badge", "themePreviewBadge");
    const previewProduct = themePreviewText(preset, "product", "themePreviewProductName");
    const previewAction = themePreviewText(preset, "action", "themePreviewAction");
    const previewPrice = Number.isFinite(Number(preset?.preview?.price)) ? Number(preset.preview.price) : 24.9;
    const previewStyle = [
    ...
    return (
      '<span class="admin-theme-card__preview" data-theme-preview-preset="' + escapeHtml(preset?.key || "") + '" style="' + escapeHtml(previewStyle) + '">' +
      '<span class="admin-theme-card__preview-shell">' +
      '<span class="admin-theme-card__preview-badge">' + escapeHtml(previewBadge) + "</span>" +
      '<span class="admin-theme-card__preview-product">' + escapeHtml(previewProduct) + "</span>" +
      '<span class="admin-theme-card__preview-price">' + escapeHtml(formatCurrency(previewPrice)) + "</span>" +
      '<span class="admin-theme-card__preview-button">' + escapeHtml(previewAction) + "</span>" +
      "</span>" +
      "</span>"
    );
  }
